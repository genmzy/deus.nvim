...
highlights.generate_syntax = function(palette, options)
  ...
  local syntax = {
    ...
    TSParameterReference = syntax_entry(palette.grey0, palette.none),
    ...
    TSStringRegex = { link = "Purple" },
    TSStringSpecial = { link = "Orange" },
    TSSymbol = { link = "Orange" },
    TSTag = { link = "Orange" },
    ...
    ["@lsp.typemod.enumMember.defaultLibrary"] = { link = "@string" },
    ...
    CocSemEnumMember = { link = "TSString" },
    ...
    LspSemanticEnumMember = { link = "TSString" },
